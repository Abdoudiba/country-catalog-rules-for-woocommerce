<?php
/**
 * Plugin Name:       Yuupee Country Catalog Rules for WooCommerce
 * Plugin URI:         https://github.com/Abdoudiba/yuupee-country-catalog-rules-for-woocommerce
 ...
 * Text Domain:        yuupee-country-catalog-rules-for-woocommerce
 */

defined( 'ABSPATH' ) || exit;

define( 'CCRW_VERSION', '0.4.0' );
...
function ccrw_woocommerce_missing_notice() {
	echo '<div class="notice notice-error"><p>' .
		esc_html__( 'Yuupee Country Catalog Rules for WooCommerce requires WooCommerce to be installed and active.', 'yuupee-country-catalog-rules-for-woocommerce' ) .
		'</p></div>';
}
